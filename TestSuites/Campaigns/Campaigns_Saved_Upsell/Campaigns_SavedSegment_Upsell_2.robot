...
*** Test Cases ***
Creating campaign with 2 channels combination - MobileNoti & Hubspot - Saved Upsell Segment
...
Creating campaign with 2 channels combination - MobileNoti & MailChimp - Saved Upsell Segment
    [Tags]  Campaign_Regression
     New Campaign with MobileNoti & MailChimp - Saved Upsell Segment
     [Teardown]  Run Keyword If Test Failed  To Reload Page

Creating campaign with 2 channels combination - Mailchimp & CSV - Saved Upsell Segment
    [Tags]  Campaign_Regression  Campaign_Sanity
...
Creating campaign with 2 channels combination - Mailchimp & Facebook - Saved Upsell Segment
    [Tags]  Campaign_Regression
     new campaign with mailchimp and facebook - Saved Upsell Segment
     [Teardown]  Run Keyword If Test Failed  To Reload Page

Creating campaign with 2 channels combination - MobileNoti & Facebook - Saved Upsell Segment
    [Tags]  Campaign_Regression
     New campaign with mobilenoti and facebook - Saved Upsell Segment
     [Teardown]  Run Keyword If Test Failed  To Reload Page

Creating campaign with 2 channels combination - MobileNoti and ConstantContact - Saved Upsell Segment
    [Tags]  Campaign_Regression
    New campaign with MobileNoti and ConstantContact - Saved Upsell Segment
    [Teardown]  Run Keyword If Test Failed  To Reload Page

Creating campaign with 2 channels combination - Mailchimp and ConstantContact - Saved Upsell Segment
    [Tags]  Campaign_Regression
    New campaign with Mailchimp and ConstantContact - Saved Upsell Segment
    [Teardown]  Logout & Login to the Application and Navigate to CMC

Creating campaign with 2 channels combination - Fb and ConstantContact - Saved Upsell Segment
    [Tags]  Campaign_Regression  Campaign_Sanity
    New campaign with Fb and ConstantContact - Saved Upsell Segment
    [Teardown]  Run Keyword If Test Failed  To Reload Page

Creating campaign with 2 channels combination - Hubspot and ConstantContact - Saved Upsell Segment
    [Tags]  Campaign_Regression
    New campaign with Hubspot and ConstantContact - Saved Upsell Segment
    [Teardown]  Run Keyword If Test Failed  To Reload Page

Creating campaign with 2 channels combination - csv and constantContact - Saved Upsell Segment
    [Tags]  Campaign_Regression
