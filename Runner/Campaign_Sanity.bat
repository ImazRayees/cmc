...
call pabot  --processes 27                ^
			--log log_1.html                ^
            --report NONE                   ^
            --output output_1.xml           ^
            --outputdir Campaign_Sanity%mydir%             ^
            --loglevel TRACE                ^
            --removekeywords WUKS           ^
            --variable SELENIUM_SPEED:0.01s ^
            --variable SELENIUM_TIMEOUT:3s  ^
            --variable PORTAL:test          ^
			--reporttitle CMC_Campaign_Campaign_Sanity        ^
            --i Campaign_Sanity                  ^
            %REL_PATH%
...
call pabot  --processes 27                ^
			--rerunfailed Campaign_Sanity%mydir%\output_1.xml ^
            --runemptysuite                    ^
            --log log_2.html                   ^
            --report NONE                      ^
            --output output_2.xml              ^
            ...
            --variable PORTAL:test             ^
			--reporttitle CMC_Campaign_Sanity           ^
            --i Campaign_Sanity                 ^
            %REL_PATH%
...
call rebot  --processemptysuite        ^
            ...
            --outputdir Campaign_Sanity%mydir%       ^
            --merge                    ^
            Campaign_Sanity%mydir%\*.xml

REM Clea up Results1 folder before you go!
del /Q Campaign_Sanity%mydir%\output_*.xml