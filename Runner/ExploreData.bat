...
call pabot  --processes 7                ^
			--log log_1.html                ^
            --report NONE                   ^
            --output output_1.xml           ^
            --outputdir Explore%mydir%             ^
            --loglevel TRACE                ^
            --removekeywords WUKS           ^
            --variable SELENIUM_SPEED:0.01s ^
            --variable SELENIUM_TIMEOUT:3s  ^
            --variable PORTAL:test          ^
			--reporttitle CMC_Explore        ^
            --i Explore_Regression                  ^
            %REL_PATH%
...
call pabot  --processes 7                ^
			--rerunfailed Explore%mydir%\output_1.xml ^
            --runemptysuite                    ^
            --log log_2.html                   ^
            --report NONE                      ^
            --output output_2.xml              ^
...
del /Q Explore%mydir%\output_*.xml
