...
class outputdata():
    ...
    def movefiles(self):
        ...
        srcfile_reporthtml = '/home/RMOHAMME/AutomationProjects/CMC/CMC-Robotframework-22.1/Results/report.html'
        srcfile_loghtml = '/home/RMOHAMME/AutomationProjects/CMC/CMC-Robotframework-22.1/Results/log.html'
        OutputXMLfile = '/home/RMOHAMME/AutomationProjects/CMC/CMC-Robotframework-22.1/Results/output.xml'
        DBUsername = 'admin'
    ...
    def S3bucketupload(self):
        ...
        # Sysadmin_ReportUrl= 'https://'+bucket_name+'.s3.us-west-2.amazonaws.com/'+foldername+'/report.html'
    def imageapi(self):
        import requests
        import os
        global Report_url
    ...
    def SendEmail(self):
        ...
        # storing the subject
        msg['Subject'] = "CMC Test Automation Stage Report - " + datetime.now().strftime('%d/%m/%Y')

        # string to store the body of the mail
        body = "Please find the CMC test automation stage report attached with this email."
